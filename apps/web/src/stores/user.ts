...
export const useUserStore = defineStore('userStore', () => {
	...
	const defaultAvatar = computed(() => user ? `${AVATAR_UPLOAD_URL}${user.value?.avatar}` : 'https://gips3.baidu.com/it/u=3493347002,3356558679&fm=3074&app=3074&f=PNG?w=2048&h=2048')
	const logout = async () => {
		user.value = null
