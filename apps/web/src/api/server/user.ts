...
export const login = (data: UserLogin): Result<UserWebResult> =>
  serverInstance.post("/user/login", data);

export const register = (data: UserRegister): Result<UserWebResult> =>
  serverInstance.post("/user/register", data);
...
export const userUpdate = (data: UserUpdate): Result<UserUpdate> =>
  serverInstance.put("/user", data);
