...
const defaultAvatar = userStore.user
  ? `${AVATAR_UPLOAD_URL}${userStore.user.avatar}`
  : "https://gips3.baidu.com/it/u=3493347002,3356558679&fm=3074&app=3074&f=PNG?w=2048&h=2048";
</script>

<template>
  <header
    class="flex items-center justify-between lg:justify-center gap-x-8 w-full p-4 border-b border-gray-200 dark:border-gray-700"
  >
    ...
    <div class="flex gap-4">
      <UPopover>
        <div
          class="flex items-center gap-2 border-l cursor-pointer border-gray-300 dark:border-gray-700 pl-4"
        >
        ...
        <template #content>
          <div v-if="userStore.user" class="p-6 space-y-4 min-w-80 gap-x-4">
            <div class="flex gap-x-4 w-80">
              ...
              <div
                class="flex-1 shadow-xs p-2 rounded border border-amber-200 bg-yellow-50 dark:bg-amber-600/10 dark:border-amber-700"
              >
            ...
            <div class="grid grid-cols-2 gap-x-4">
              ...
              <UPopover>
                <!-- 触发按钮 -->
                <UButton class="inline-flex justify-center" color="error" black> 退出 </UButton>
